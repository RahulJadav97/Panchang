                  ...
                  FutureBuilder<Translation>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        ...
                        return  Text("Monthly Festivals", style:font_style.White_700_18_ff ,);
                      }
                    },
                  ),
                  // Text("Monthly Festivals", style:font_style.White_700_18_ff ,),
                                     ...
                                     child: Container(
                                       ...
                                       child: Padding(
                                           ...
                                           child: Column(
                                             ...
                                             children: [
                                               FutureBuilder<Translation>(
                                                 future: translator.translate("${monthFestival.monthFestivalList[index].title}", to: "${selectedLanguage}"), // Translate to Hindi ("hi")
                                                 builder: (context, snapshot) {
                                                   if (snapshot.hasData) {
                                                     return Text(
                                                       snapshot.data!.text,
                                                     ...
                                                     return  Text('${monthFestival.monthFestivalList[index].title}',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.white));
                                                   }
                                                 },
                                               ),
                                               ...
                                               FutureBuilder<Translation>(
                                                 future: translator.translate("Date: ${monthFestival.monthFestivalList[index].date}", to: "${selectedLanguage}"), // Translate to Hindi ("hi")
                                                 builder: (context, snapshot) {
                                                   if (snapshot.hasData) {
                                                     return Text(
                                                         snapshot.data!.text,
                                                     ...
                                                     return   Text('Date: ${monthFestival.monthFestivalList[index].date}',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,color: Colors.white));
                                                   }
                                                 },
                                               ),
